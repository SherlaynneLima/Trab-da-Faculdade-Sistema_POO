...
public class TelaInicial extends JFrame {
	...
	public TelaInicial() {
        ...
        btnRelatorio.setBounds(239, 233, 200, 30);
        JanelaInicial.add(btnRelatorio);
        
        JButton btnVerAgendamentos = new JButton("Ver Lista de Agendamentos");
        btnVerAgendamentos.setFont(new Font("Dialog", Font.BOLD, 12));
        btnVerAgendamentos.setBackground(new Color(135, 206, 235));
        btnVerAgendamentos.setBounds(449, 152, 200, 30);
        JanelaInicial.add(btnVerAgendamentos);
     ...
     // btnVerFuncionario
        btnVerFuncionario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                TelaListaFuncionarios telaListaFunc = new TelaListaFuncionarios();
